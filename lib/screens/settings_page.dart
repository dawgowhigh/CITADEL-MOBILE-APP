...
import 'package:citadel/screens/my_profile_page.dart';
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        Text(
          "1. Authorized Use",
          style: TextStyle(fontSize: 14, fontFamily: "Sora", fontWeight: FontWeight.w700),
        ),
        SizedBox(height: 8),
        Text(
        ...
        SizedBox(height: 8),
        Text(
          " are prohibited from engaging iUsersn any activity that may disrupt, damage, or misuse the application or its services.",
          style: TextStyle(fontSize: 14, fontFamily: "Sora"),
        ),
        SizedBox(height: 12),
        Text(
        ...
        SizedBox(height: 12),
        Text(
          "6. Data Protection\nThe collection and processing of personal information are governed by the Data Privacy Policy, in compliance with the Data Privacy Act of 2012 (RA 10173).",
          style: TextStyle(fontSize: 14, fontFamily: "Sora"),
        ),
        SizedBox(height: 12),
        Text(
          "7. Amendments\nUniversity of Caloocan City – Bagong Silang Campus reserves the right to alter or update these Terms and Conditions at any time. Continued use of the application constitutes acceptance of the revised terms.",
          style: TextStyle(fontSize: 14, fontFamily: "Sora"),
        ),
      ],
    );
